...
[`@aws-sdk/client-transcribe-streaming`](https://www.npmjs.com/package/@aws-sdk/client-transcribe-streaming/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hDBxyLDdzIOc73dl0BKLztJ2f1DOTF1xxNI0iQcdzVQ9QXJ+ztH7CndDMnXxHxQf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-transcribe-streaming": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.775.0/index.min.mjs": "sha384-hDBxyLDdzIOc73dl0BKLztJ2f1DOTF1xxNI0iQcdzVQ9QXJ+ztH7CndDMnXxHxQf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-transcribe-streaming/blob/refs/tags/3.775.0/LICENSE
```
