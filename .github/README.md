...
[`@aws-sdk/client-transcribe-streaming`](https://www.npmjs.com/package/@aws-sdk/client-transcribe-streaming/v/3.1048.0).
...
- @aws-sdk/client-transcribe-streaming - [https://cloud-sdk-builds.github.io/?sdk=client-transcribe-streaming](https://cloud-sdk-builds.github.io/?sdk=client-transcribe-streaming)
- @aws-sdk/client-transcribe-streaming v3.1048.0 - [https://cloud-sdk-builds.github.io/?sdk=client-transcribe-streaming&version=3.1048.0](https://cloud-sdk-builds.github.io/?sdk=client-transcribe-streaming&version=3.1048.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.1048.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s70sBWs3ec35aPp0ilQLAGMvQ0wJq4iqedjwQptzQIuiyKpOatrxeW/F3I2YtqwT
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-transcribe-streaming": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.1048.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.1048.0/index.min.mjs": "sha384-s70sBWs3ec35aPp0ilQLAGMvQ0wJq4iqedjwQptzQIuiyKpOatrxeW/F3I2YtqwT"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-transcribe-streaming";
...
```
https://github.com/cloud-sdk-builds/client-transcribe-streaming/blob/refs/tags/3.1048.0/LICENSE
```
