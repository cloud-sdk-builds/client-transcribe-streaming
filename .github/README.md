...
[`@aws-sdk/client-transcribe-streaming`](https://www.npmjs.com/package/@aws-sdk/client-transcribe-streaming/v/3.1121.0).
...
- @aws-sdk/client-transcribe-streaming v3.1121.0 - [https://cloud-sdk-builds.github.io/?sdk=client-transcribe-streaming&version=3.1121.0](https://cloud-sdk-builds.github.io/?sdk=client-transcribe-streaming&version=3.1121.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.1121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p6Ozu51zaFR9+9mbc20rbFBUzT2T2+JNg7eRt9Yf04krpa++QYJonaNoSOxroINN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-transcribe-streaming": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.1121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-transcribe-streaming@3.1121.0/index.min.mjs": "sha384-p6Ozu51zaFR9+9mbc20rbFBUzT2T2+JNg7eRt9Yf04krpa++QYJonaNoSOxroINN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-transcribe-streaming/blob/refs/tags/3.1121.0/LICENSE
```
